...
// Shiny odds (upgraded to a chance of about 0.05%)
...
#define MAX_PER_STAT_EVS ((P_EV_CAP >= GEN_6) ? 0 : 0) // Also edited to 0
#define MAX_TOTAL_EVS 0 // Should prevent EV gain
#define EV_ITEM_RAISE_LIMIT ((I_VITAMIN_EV_CAP >= GEN_8) ? MAX_PER_STAT_EVS : 0) // Also edited to 0
