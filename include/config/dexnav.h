...
#define DN_VAR_SPECIES                FLAG_UNUSED_0x024 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           FLAG_UNUSED_0x025 // Steps for finding hidden pokemon
...
#define SEARCHLEVEL100_ABILITYCHANCE    80
